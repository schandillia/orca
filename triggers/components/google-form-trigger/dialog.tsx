...
import { generateGoogleFormScript } from "@/triggers/components/google-form-trigger/utils"
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] flex-col">
        ...
        <div className="mt-4 flex-1 overflow-y-auto space-y-4 pretty-scrollbar pr-4 -mr-4">
